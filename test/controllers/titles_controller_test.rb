...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { image_url: @title.image_url, post: @title.post } }, as: :json
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { image_url: @title.image_url, post: @title.post } }, as: :json
    assert_response 200
  end
