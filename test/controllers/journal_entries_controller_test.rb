...
class JournalEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal_entry" do
    assert_difference('JournalEntry.count') do
      post journal_entries_url, params: { journal_entry: { img_url: @journal_entry.img_url, post: @journal_entry.post, title: @journal_entry.title } }, as: :json
    end
  ...
  test "should update journal_entry" do
    patch journal_entry_url(@journal_entry), params: { journal_entry: { img_url: @journal_entry.img_url, post: @journal_entry.post, title: @journal_entry.title } }, as: :json
    assert_response 200
  end
