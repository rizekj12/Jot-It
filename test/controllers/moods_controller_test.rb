...
class MoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mood" do
    assert_difference('Mood.count') do
      post moods_url, params: { mood: { mood_icon: @mood.mood_icon, name: @mood.name } }, as: :json
    end
  ...
  test "should update mood" do
    patch mood_url(@mood), params: { mood: { mood_icon: @mood.mood_icon, name: @mood.name } }, as: :json
    assert_response 200
  end
